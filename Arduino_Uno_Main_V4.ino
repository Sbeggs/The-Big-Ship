...
bool leftMotorDirection = false;

// PID Variables
unsigned int pwm_R = 245;
unsigned int pwm_L = 245;
int speed_L=0;
int speed_R=0;
int Kp=2; 
int error_L;
...
void loop() {
  ...
  if (command == 'w') {
    ...
    encoderControl(travel_distance, leftMotorDirection);

    
//    while(abs(counterarray[0])<travel_distance){
//      encoder();
...
if (command == 'd') {
    ...
    leftMotorDirection = false;
    encoderControl(right_turn_distance, leftMotorDirection);
...
if (command == 'a') {
    ...
    // spin left some distance
      ...
      leftMotorDirection = true;
      encoderControl(left_turn_distance, leftMotorDirection);
...
void encoderControl(int distance, bool leftMotorSpin){
    while(abs(counterarray[0])<distance){
      encoder();
      Serial.print("RHcounter: ");
      Serial.println(counterarray[0]);
      Serial.print("LHcounter: ");
